                        ...
                        <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8">
                            <div className="max-w-4xl mx-auto text-center">
                                <h2 className="text-3xl leading-9 font-extrabold md:text-4xl md:leading-10">
                                    Already hated by the CI dinosaurs
                                </h2>
                            </div>
                        </div>
                    ...
                    <div className="relative max-w-xl mx-auto px-4 md:px-6 lg:px-8 lg:max-w-screen-xl">
                        <div className="relative">
                            <h3 className="text-center text-3xl leading-8 font-extrabold tracking-tight md:text-4xl md:leading-10">
                                Solve CI challenges with a slurp
                            </h3>
                            <p className="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-description">
                                Slurps are only helpful when your users can find answers easily.
                                Enter CodeComet CI.
                            </p>
                        </div>
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-description">
                                                ...
                                                CodeComet quickly evolved into a successful community
                                ...
                                <li className="mt-10 lg:mt-0">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-description">
                                                CodeComet understands how the user input fits into the
                        ...
                        <div className="max-w-screen-xl mx-auto pt-6 px-4 md:px-6 lg:px-8">
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                                    ...
                                    CodeComet application and send you the snippet you'll have to
                                ...
                                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                                    <div>
                                        <div className="flex items-center justify-center">
                                            <img
                                                ...
                                                width="190px"
                                                height="220px"
                                                alt="Scraping with CodeComet Crawler"
                                            />
                                        </div>
                                    ...
                                    <div className="mt-10 lg:mt-0 p-4">
                                        <div className="h-200 flex items-center justify-center">
                                            <img
                                                src={withBaseUrl('img/configuration.svg')}
                                                width="140px"
                                                height="220px"
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-600">
                                                ...
                                                CodeComet account. We take care of this for you!
                                            </p>
                                        </div>
                                    </div>
                                    <div className="mt-10 lg:mt-0 p-4">
                                        <div className="h-200 flex items-center justify-center">
                                            <img
                                                src={withBaseUrl('img/implementation.svg')}
                                                width="220px"
                                                height="220px"
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-600">
                                                We'll send you a small snippet to integrate CodeComet to
                                                your website and an invite to your fully configured
                                                CodeComet application.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-2 text-base leading-6 text-description">
                                                    ...
                                                    CodeComet comes with our extensive experience in
                                    ...
                                    <li className="mt-10">
                                        <div className="flex">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-2 text-base leading-6 text-description">
                                                    CodeComet organizes the search results into chunks
                            ...
                            <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                                ...
                                <div className="mt-10 -mx-4 lg:mt-0 lg:col-start-1 uil-ta-center">
                                    <img
                                        ...
                                        width="490"
                                        src={withBaseUrl('img/anatomy.svg')}
                                        alt="anatomy-of-CodeComet"
                                    />
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-2 text-base leading-6 text-gray-300">
                                                    ...
                                                    CodeComet can run a new search on every keystroke and
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-2 text-base leading-6 text-gray-300">
                                                    ...
                                                    the first keystroke, thanks to CodeComet speed.
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="mt-10">
                                        <div className="flex">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-2 text-base leading-6 text-gray-300">
                                                    CodeComet knows what your users mean to search for right
                    ...
                    <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-description lg:mx-auto">
                                ...
                                and faster at doing what they need to. CodeComet offers
                            ...
                            <div className="pt-12 items-center justify-center flex">
                                <img
                                    ...
                                    src={withBaseUrl('img/keyboard.png')}
